...
CREATE SEQUENCE "TRAINED_PREDICTION_MODELS_ID_SEQ" START WITH 1;

CREATE TABLE IF NOT EXISTS "TRAINED_PREDICTION_MODELS" (
    "ID" BIGINT GENERATED BY DEFAULT AS SEQUENCE "TRAINED_PREDICTION_MODELS_ID_SEQ" PRIMARY KEY,
    "STRATEGY" LONGVARCHAR NOT NULL,
